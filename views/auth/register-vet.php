...
<div class="w-100">
    ...
    <h2 class="auth-form-title">Veterinarian Join</h2>
    <p class="auth-form-subtitle">Apply to become a verified PetGuard Vet.</p>
    ...
    <form action="<?= ViewHelper::url('register/veterinarian') ?>" method="POST">
        ...
        <div class="auth-input-group mb-2">
            ...
            <input type="text" name="name" class="form-control auth-control" value="<?= ViewHelper::e(ViewHelper::old('name')) ?>" required placeholder="Full Name (e.g. Dr. Smith)">
        </div>
...
<div class="row g-2 mb-2">
            ...
            <div class="col-md-6">
                <div class="auth-input-group">
                    ...
                    <input type="tel" name="phone" class="form-control auth-control" value="<?= ViewHelper::e(ViewHelper::old('phone')) ?>" required placeholder="Contact Phone">
                </div>
            </div>
        </div>
...
<div class="row g-2 mb-2">
            <div class="col-md-6">
                <div class="auth-input-group">
                    ...
                    <input type="text" name="license_number" class="form-control auth-control" value="<?= ViewHelper::e(ViewHelper::old('license_number')) ?>" required placeholder="Medical License #">
                </div>
            </div>
            <div class="col-md-6">
                <div class="auth-input-group">
                    ...
                    <input type="text" name="specialization" class="form-control auth-control" value="<?= ViewHelper::e(ViewHelper::old('specialization')) ?>" required placeholder="Specialization">
                </div>
            </div>
        </div>
        ...
        <div class="auth-input-group mb-2">
            ...
            <input type="text" name="clinic_address" class="form-control auth-control" value="<?= ViewHelper::e(ViewHelper::old('clinic_address')) ?>" required placeholder="Clinic / Hospital Address">
        </div>
...
<div class="row g-2 mb-2">
        ...
        <button type="submit" class="btn-auth-primary">
            Apply as Vet <i class="fa-solid fa-user-doctor ms-1"></i>
        </button>
    </form>
</div>