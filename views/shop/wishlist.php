        ...
        <div class="row align-items-center">
            <div class="col-lg-12 text-center">
                <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill bg-white shadow-sm text-dark small mb-3 border">
                    ...
                    <span class="fw-semibold text-dark">Personal Saved Items</span>
                </div>
                <h1 class="text-dark fw-bold mb-2" style="font-family: 'Anybody', sans-serif; font-size: clamp(26px, 5vw, 40px);">My Wishlist</h1>
                <ul class="d-inline-flex list-unstyled gap-2 text-muted small justify-content-center m-0 align-items-center">
                    ...
                    <li class="text-muted">/</li>
                    <li class="text-brand fw-bold">Wishlist</li>
                </ul>
            </div>
        </div>
    </div>
