    ...
    <div class="portal-hero-welcome d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill bg-white bg-opacity-10 text-white small mb-2">
                ...
                <span>Merchant Identity &amp; Policies</span>
                <span class="text-white-50">&middot;</span>
                <span class="font-monospace text-warning"><?= ViewHelper::e($profile['business_registration'] ?? 'TX-BUS-98231') ?></span>
            </div>
            <h2 class="portal-hero-title">Store Branding &amp; Commercial Terms 🛍️</h2>
            <p class="portal-hero-subtitle">
                Customize your public storefront brand identity, commercial registration, and shipping terms.
            </p>
        </div>
