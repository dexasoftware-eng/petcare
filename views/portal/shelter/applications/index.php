    ...
    <div class="portal-hero-welcome d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill bg-white bg-opacity-10 text-white small mb-2">
                ...
                <span>Rescue Adoption Pipeline</span>
                <span class="text-white-50">&middot;</span>
                <span class="font-monospace text-warning"><?= $reviewCount ?> Under Review</span>
            </div>
            <h2 class="portal-hero-title">Adoption Applications &amp; Placement 📋</h2>
            <p class="portal-hero-subtitle">
                Screen prospective pet parent questionnaires, verify home setups, launch virtual interviews, and approve adoptions.
            </p>
        </div>
