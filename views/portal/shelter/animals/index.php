    ...
    <div class="portal-hero-welcome d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill bg-white bg-opacity-10 text-white small mb-2">
                ...
                <span class="font-monospace text-warning"><?= $availableCount ?> Available for Adoption</span>
            </div>
            <h2 class="portal-hero-title">Rescue Residents &amp; Directory 🐾</h2>
            <p class="portal-hero-subtitle">
                Manage shelter residents, update health &amp; vaccination statuses, and publish listings to the adoption network.
            </p>
        </div>
