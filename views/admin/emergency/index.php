...
<div class="portal-hero-welcome d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4" style="background: linear-gradient(135deg, #991b1b 0%, #7f1d1d 60%, #450a0a 100%);">
    <div>
        <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill bg-white bg-opacity-10 text-white small mb-2">
            ...
            <span>Rapid Critical Response</span>
            <span class="text-white-50">&middot;</span>
            <span class="font-monospace text-warning"><?= count($events) ?> Incidents Logged</span>
        </div>
        <h2 class="portal-hero-title">Emergency Center &amp; Triage 🚨</h2>
        <p class="portal-hero-subtitle text-white text-opacity-75">
            Critical pet incidents, poisoning alerts, trauma triage, and emergency veterinarian dispatch.
        </p>
    </div>
