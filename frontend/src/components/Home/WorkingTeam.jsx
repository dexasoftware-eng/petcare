    ...
    <section>
      <div className="container">
        <SectionHeading
          ...
          title="Best Working Team"
        />
        <div className="row g-4 mt-2">
          {team.map((member, idx) => (
            <div
              key={member.id}
              className={`col-lg-4 col-md-6 ${idx === team.length - 1 ? 'mb-0' : ''}`}
            >
              <div className="team-working text-center">
                ...
                <ul className="social-icon list-unstyled d-flex justify-content-center gap-2 mt-3">
                  <li>
