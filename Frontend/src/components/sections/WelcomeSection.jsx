        ...
        <div className="row">
              ...
              <div className="row mt-lg-5">
                <div className="col-md-6">
                  <div className="pet-grooming">
                    <i>
                      <img src="/assets/img/welcome-to-1.png" alt="icon" />
                    </i>
                ...
                <div className="col-md-6">
                  <div className="pet-grooming mb-0">
                    <i>
                      <img src="/assets/img/welcome-to-2.png" alt="icon" />
                    </i>
                    <svg width="138" height="138" viewBox="0 0 673 673" xmlns="http://www.w3.org/2000/svg">
                      <path
                        fillRule="evenodd"
          ...
          <div className="col-lg-6">
            <div className="dog-walker two d-block">
              <img src="/assets/img/puppies.png" className="puppies" alt="puppies" />
              <img src="/assets/img/dog-walker-1.png" className="w-100" alt="dog walker" />
              <img src="/assets/img/line.png" className="line" alt="line" />
              <img src="/assets/img/dabal-foot.png" className="dabal-foot" alt="dabal-foot" />
              <img src="/assets/img/haddi.png" className="haddi" alt="haddi" />
            </div>
          </div>
        </div>
      </div>
