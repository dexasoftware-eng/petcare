        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="heading two">
              <h2>Building the Future of Connected Pet Care</h2>
            </div>
            <div className="love-your-pets">
              ...
              <ul className="list">
                <li>
                  <img src="/assets/img/list.png" alt="list icon" /> Centralized digital health records for complete medical continuity
                </li>
                <li>
                  <img src="/assets/img/list.png" alt="list icon" /> Direct scheduling and care coordination with certified veterinarians
                </li>
                <li>
                  <img src="/assets/img/list.png" alt="list icon" /> Dedicated digital shelter tools to showcase adoptable rescue pets
                </li>
                <li>
                  <img src="/assets/img/list.png" alt="list icon" /> Secure role-based architecture designed for each care stakeholder
                </li>
              </ul>
