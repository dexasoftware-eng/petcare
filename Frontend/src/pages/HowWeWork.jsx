...
export default function HowWeWork({ onOpenLightbox }) {
  return (
    <>
      <section
        className="banner"
      ...
      >
        <div className="container">
          <h2 style={{ fontSize: '42px', fontWeight: 'bold', marginBottom: '10px' }}>How We Work</h2>
          <ul
          ...
          >
            ...
            <li>/</li>
            <li className="active" style={{ color: '#fa441d' }}>How We Work</li>
          </ul>
        </div>
      </section>
